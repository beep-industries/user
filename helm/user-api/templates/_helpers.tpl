...
*/}}
{{- define "user-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "user-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "user-api.databaseSecretName" -}}
{{- if .Values.database.existingSecret }}
{{- .Values.database.existingSecret }}
{{- else }}
{{- include "user-api.fullname" . }}-db
{{- end }}
{{- end }}

{{/*
Secret name for Keycloak
*/}}
{{- define "user-api.keycloakSecretName" -}}
{{- if .Values.keycloak.existingSecret }}
{{- .Values.keycloak.existingSecret }}
{{- else }}
{{- include "user-api.fullname" . }}-keycloak
{{- end }}
{{- end }}
